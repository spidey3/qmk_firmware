...
#        define RGBLIGHT_DEFAULT_MODE_end RGBLIGHT_MODE_TWINKLE_end
#    elif defined(RGBLIGHT_EFFECT_RAINBOW_MOOD)
#        define RGBLIGHT_DEFAULT_MODE RGBLIGHT_MODE_RAINBOW_MOOD
#        define RGBLIGHT_DEFAULT_MODE_end RGBLIGHT_MODE_RAINBOW_MOOD_end
#    else
#        define RGBLIGHT_DEFAULT_MODE RGBLIGHT_MODE_STATIC_LIGHT
#        define RGBLIGHT_DEFAULT_MODE_end RGBLIGHT_MODE_STATIC_LIGHT
#    endif
