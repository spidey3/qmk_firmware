...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT_75_ansi(
        ...
        EEP_RST,    X(T_A1),    X(T_A12),   X(T_A123),  X(T_A1234), X(T_12),    X(T_123),   X(T_1234),  X_BUL,      X(T_12345), X(SURPRISE),X_DASH,     XXXXXXX,                KC_PAUS,    KC_SLCK,
        XXXXXXX,    X(T_A103),  X(T_1034),  X(T_103),   X(T_1034),  X(T_103456),RGB_SAI,    RGB_VAD,    RGB_VAI,    SPI_GLO,    VLK_TOG,    XXXXXXX,    XXXXXXX,                XXXXXXX,    KC_BRIU,
